...
export const SITE_CONFIG = {
  ...
  // PostHog product analytics. The key is a public project token, safe to ship
  // in client code. Override per environment with NEXT_PUBLIC_POSTHOG_KEY / _HOST.
  posthog: {
    key: process.env.NEXT_PUBLIC_POSTHOG_KEY || 'phc_pduQ7kjqpCoDZx9H4rPJ4viziLkXgffGP52JkBUtBNk6',
